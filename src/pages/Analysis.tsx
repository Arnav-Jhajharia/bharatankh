...
const Analysis = () => {
  ...
  const renderCashFlowContent = () => (
    <div>
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={cashFlowData} margin={{ top: 10, right: 10, left: 0, bottom: 10 }}>
            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f0f0f0" />
            <XAxis dataKey="name" axisLine={false} tickLine={false} />
            <YAxis 
              axisLine={false} 
        ...
        {behaviorData.map((item, index) => (
          <div key={index}>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div 
                className="bg-gradient-to-r from-orange-500 to-blue-400 h-2 rounded-full transition-all duration-500"
  ...
  return (
    <PageContainer>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
        ...
        {/* Tab Content */}
        <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in mt-4">
          {/* Score Section */}
