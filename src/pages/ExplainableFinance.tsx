...
const ExplainableFinance = () => {
  ...
  const [openItems, setOpenItems] = useState<string[]>(["item-2"]);
  ...
  const strengths = [
    ...
    {
      id: "strength-2",
      title: "Good savings rate (32% of income)",
      description: "Your savings rate is above the recommended 20%, which is building a solid financial foundation for your future goals."
    }
  ];
  ...
  return (
    <PageContainer>
      ...
      {/* New Financial Insights Card with White Background */}
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {/* Second Strength - Expanded */}
                <div className={`border rounded-md ${isItemOpen('item-3') ? 'border-green-500' : 'border-green-200'}`}>
                  <div 
                    className="flex justify-between items-center p-4 cursor-pointer bg-green-50 rounded-t-md"
