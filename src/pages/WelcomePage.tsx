      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: UserCheck, title: "Verify Identity", description: "Complete KYC with Aadhaar in minutes" },
              { icon: CreditCard, title: "Link Bank Account", description: "Securely connect via Account Aggregator" },
              { icon: BarChart3, title: "Get Your Score", description: "Instant BharatAnkh Score based on transactions" }
            ].map((step, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-orange-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { number: "50L+", label: "Gig Workers Served" },
              { number: "₹500Cr+", label: "Credit Facilitated" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { icon: Award, title: "RBI Compliant", desc: "Fully regulated platform" },
              { icon: Clock, title: "Real-time Updates", desc: "Instant score updates" },
              { icon: Globe, title: "Pan-India Coverage", desc: "Available nationwide" }
            ].map((trust, index) => (
              <motion.div
                key={index}
                initial={{ y: 30, opacity: 0 }}
